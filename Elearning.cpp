/* TUGAS TUGAS E-LEARNING
*	 OLEH Cepi Saepul Rohman 16.111.320
...
int void gg(){
	...
	KA.noKA = "BDO-Parahiyangan-0103";
	KA.nmKA = "Argo-Parahiyangan";
	jd.wkt_brkt.i= 12; jd.wkt_tiba.i= 15;
	jd.wkt_brkt.m= 10; jd.wkt_tiba.m= 10;
	jd.wkt_brkt.s= 11; jd.wkt_tiba.s= 11;
	jd.tgl_bkt.tahun= 2017;
	
	system("CLS");
	cout<<"DATA PERJALANAN KERETA API OKE\n";
	...
	cout<<" > Tgl:";cin>> jd.tgl_bkt.hari;cout<<" > Bulan:";cin>> jd.tgl_bkt.bulan;
			...
			else if(jd.kotaAsal == "jakarta")harga_awal = 150000;
			else if(jd.kotaAsal == "jogjakarta")harga_awal = 150000;
			
				//TUJUAN
				 if(jd.kotaTujuan == "bandung")harga_akhir = 100000;
			else if(jd.kotaTujuan == "jakarta")harga_akhir = 150000;
